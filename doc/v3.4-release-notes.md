...
- **Barcodes live on the glass** — each glass records the barcode scanned at that event; scanning resolves from your own glass history (per-package volume/price/alc), with the brew's code kept as a fallback seed (#744)
